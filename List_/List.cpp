...
void List::Del(int pos)
{
 ...
 void List::Insert(int data, int pos)
 {
    ...
    {
        Elem* temp = GetElem(pos);
        Elem* prevElem = temp->prev;
...
List List::operator-()
{
    ...
    while (temp != nullptr)
    {
        reversedList.AddTail(temp->data);
        temp = temp->prev;
    }
...
void main()
{
    ...
    // Распечатка исходного списка
    cout << "Original List L:\n";
    L.Print();

    // Тестируем метод Insert
    cout << "\nInserting element 99 at position 3:\n";
    L.Insert(99, 3);
    L.Print();
    ...
    cout << "\nInserting element 700 at the start:\n";
    L.Insert(700,1);
    L.Print();

    cout << "\nInserting element 200 at the end:\n";
    L.Insert(200, L.GetCount() + 1);
    L.Print();
